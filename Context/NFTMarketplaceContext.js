...
const projectId = "2PJxaTcMgJt2B4INUdY5S2C3UmB";
//const projectSecretKey = process.env.NEXT_PUBLIC_SECRECT_KEY;
const projectSecretKey ="c5cb026ceceb6620d9c716688e005cac";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

//const subdomain = process.env.NEXT_PUBLIC_SUBDOMAIN;
const subdomain="https://debdyuti-nft-marketplace.infura-ipfs.io";
